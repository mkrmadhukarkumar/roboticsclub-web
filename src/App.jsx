  ...
  return (
    <div className="min-h-screen bg-black text-white flex items-center justify-center px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto text-center">
        <h1 className="text-3xl md:text-4xl font-semibold text-cyan-400">404 - Page Not Found!</h1>
  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        <Route path="/roboticsclub-web/projects/:pid" element={<ProjectDetails />} />        
        <Route path="/roboticsclub-web/ongoingprojects/:pid" element={<OngoingProjectDetails />} />
        <Route path="/roboticsclub-web/events" element={<Events />} />
        <Route path="/roboticsclub-web/register/:eventid" element={<EventRegistration />} />        
        <Route path="/roboticsclub-web/pastevents/:eventid" element={<PastEventDetails />} />
        <Route path="/roboticsclub-web/team" element={<Team />} />
        <Route path="/roboticsclub-web/achievements" element={<Achievements />} />
