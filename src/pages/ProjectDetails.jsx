        ...
        <div className="max-w-8xl mx-auto text-center">
          <div className="relative ">
            <img 
              src={project.image} 
              alt={project.title} 
              className="w-full max-w-6xl mx-auto h-80 md:h-100 lg:h-110 object-cover rounded-2xl shadow-xl transform hover:scale-105 transition duration-300" 
            />
      ...
      <section className="p-4">
        <div className="max-w-6xl mx-auto">
          <div className="bg-gray-800 bg-opacity-90 backdrop-blur-lg rounded-2xl p-6 md:p-8 shadow-2xl">
            ...
            <p className="text-gray-300 mb-8 leading-relaxed text-base md:text-lg">{project.description}</p>
