...
const upcomingEventsData = [
  ...
  },
  {
    ...
    venue: 'Club Lounge',
    description: 'Network with fellow robotics enthusiasts over drinks and demos.',
...
const pastEventsData = [
  {
    ...
    category: 'Workshops',
    photos: ['https://m.media-amazon.com/images/I/91Kie2Sjt0L._SX445_.jpg', 'https://mahatmainternational.ac.in/wp-content/uploads/2025/07/Robotics-Workshop-for-Students-Teachers-1.png']
  },
  {
    id: 2,
    ...
    category: 'Competitions',
    photos: ['https://www.sjsreview.com/wp-content/uploads/2018/04/Screen-Shot-2018-04-16-at-10.44.50-AM-e1523914554247.png']
  },
  {
    id: 3,
    ...
    category: 'Guest Lectures',
    photos: ['https://www.jct.ac.in/engineering/wp-content/uploads/2021/01/img_20200211-1-scaled.jpg', 'https://cdn.shopify.com/s/files/1/0014/4313/5560/files/unnamed_2_baddf1f7-c7ff-477e-bae9-7dee7fbc7c9b.png?v=1739900729']
  }
];
...
const Events = () => {
  ...
  useEffect(() => {
    let filtered = upcomingEventsData.filter(event => filterCategory === 'All' || event.category === filterCategory);
    if (sortBy === 'date') {
