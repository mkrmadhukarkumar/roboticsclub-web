    ...
    <div className="min-h-screen bg-black text-white">
      ...
      >
        ...
        <div className="relative z-5 text-center px-4">
          <h1 className="text-4xl md:text-8xl font-bold mb-4 text-blue-500/80">
            Robotics Club
          </h1>
          <p className="text-xl md:text-2xl mb-8 text-stone-300/80">
            Building the Future with Robotics
          </p>
          <button
            onClick={handleJoinUs}
            className="cursor-pointer bg-blue-600/70 hover:bg-blue-700/80 text-white font-bold py-3 px-8 rounded-full transition duration-300 transform hover:scale-105 shadow-lg hover:shadow-blue-500/50"
          >
            Join Us
          </button>
        </div>
        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="relative flex items-center justify-between">
            ...
            >
              ...
              <p className="text-lg text-gray-300">{upcomingevents[currentEvent].desc}</p>
        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="text-center md:text-right">
            <p className="mb-2 text-gray-300">
              <b>Email: </b>
              <Link to="mailto:roboticsclub@nitp.ac.in" className="text-cyan-400 hover:text-cyan-300">roboticsclub@nitp.ac.in</Link>
            </p>
            <p className="mb-2 text-gray-300">
              <b>Phone: </b>
              <Link to="tel:0612-2371715" className="text-cyan-400 hover:text-cyan-300">0612-2371715</Link>
            </p>
          </div>
        </div>
      </footer>
