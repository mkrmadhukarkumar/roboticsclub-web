  ...
  return (
    <div className="min-h-screen bg-black text-white pt-24">
      ...
      <section className="p-4 text-center">
        <h1 className="text-5xl pb-2 md:text-6xl font-bold mb-4 text-cyan-400">
          {project.name}
        </h1>
              ...
              <div>
                ...
                <ul className="text-gray-300 list-disc list-inside space-y-1">
                  {project.team.map((member, index) => (
                    <li key={index} className="hover:text-cyan-300 transition-colors duration-300">{member}</li>
                  ))}
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="text-gray-300 space-y-3 mb-6">
                  {project.milestones.map((milestone, index) => (
                    <li key={index} className="flex items-center hover:scale-105 transition-all duration-300 hover:text-cyan-300">
